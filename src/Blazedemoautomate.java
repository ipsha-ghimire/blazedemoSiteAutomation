...
public class Blazedemoautomate {
	...
	public void initializedriver() { // how to pass function as an argument in java
	...
	public static void main(String[] args) {
		...
		b1.initializedriver();
		b1.departcity("Boston");
		b1.destinationcity("New York");
		b1.chooseflight("Lufthansa");
		b1.reserveddetail("John", "US", "Woodland", "California", 12345, "dinersclub", 123456789, 10, 2024, "Harry Styles");

		Blazedemoautomate b2 = new Blazedemoautomate();
		b2.initializedriver();
		b2.departcity("Boston");
		b2.destinationcity("New York");
		b2.chooseflight("Lufthansa");
		b2.reserveddetail("Johny", "US", "Woodland", "California", 12345, "visa", 123456789, 10, 2024, "Taylor Swift");
	}
